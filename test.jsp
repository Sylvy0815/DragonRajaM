...
<html lang="ko">
    <head>
        ...
        <title>사거리</title>
        <!-- Bootstrap -->
        <link href="/DragonRajaM/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css"/>
        <link href="/DragonRajaM/image/icon/HalfLife.ico" rel="shortcuticon">
        <!-- jQuery (부트스트랩의 자바스크립트 플러그인을 위해 필요한) -->
        <script src="//code.jquery.com/jquery.js"></script>
        <!-- 모든 합쳐진 플러그인을 포함하거나 (아래) 필요한 각각의 파일들을 포함하세요 -->
        <script src="/DragonRajaM/bootstrap/js/bootstrap.min.js"></script>
        <!-- Respond.js 으로 IE8 에서 반응형 기능을 활성화하세요 (https://github.com/scottjehl/Respond) -->
        <script src="/DragonRajaM/bootstrap/js/respond.js"></script>
    </head>
    <body>
        <div class="container"><!-- 좌우측의 공간 확보 -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="text-right">
                        <a href="http://www.naver.com" target="_blank"><img src="/DragonRajaM/image/icon/naverIcon.PNG" alt="네이버 블로그" width="20" height="20" class="img-rounded"></a>
                        <a href="http://www.facebook.com" target="_blank"><img src="/DragonRajaM/image/icon/facebookIcon.PNG" alt="네이버 블로그" width="20" height="20" class="img-rounded"></a>
                        <a href="http://www.twitter.com" target="_blank"><img src="/DragonRajaM/image/icon/twitterIcon.PNG" alt="네이버 블로그" width="21" height="21" class="img-rounded"></a>
                    </p>
                </div>
            </div>
            <!--// 헤더 들어가는 부분 -->
...
개인정보의 항목 및 수집방법
        ...
        <script>
            ...
            <div>
                <p class="text-center">
                    <small><strong> 드래곤라자M 길드전용 페이지</strong></small><br>
                    <small>제작자 : 이효준 ㆍ 소속 :  PNU ITE ㆍ 학번:201545833 ㆍ 전화 : 010-8684-3675</small><br>
					<small>서울특별시 강남구 테헤란로32길 26 청송빌딩</small><br>
                    <small>COPYRIGHT (c) 2016 LOCOJOY INTERNATIONAL CORP. ALL RIGHT RESERVED.</small>
                </p>
            </div>
            <!--// 푸터 들어가는 부분 -->
        </div>
